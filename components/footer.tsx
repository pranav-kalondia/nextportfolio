          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <a
                ...
                className="grid h-9 w-9 place-items-center rounded-full border border-black/15 bg-white text-[#111110] transition hover:-translate-y-[1px] hover:border-black/45 hover:bg-black/[0.03]"
              >
                {social.icon}
              </a>
            ))}
